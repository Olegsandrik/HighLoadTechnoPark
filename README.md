...
* Для хранения таблиц Films, Genres, Actors будет использоваться **PostgreSQL+Citus**, так как объем данных позволяет пользоваться SQL вариантом и нужно распределить систему на несколько ДЦ.
...
**Нужно доделать: посчитать таблицу Расчет размера данных и нагрузки на чтение/запись
