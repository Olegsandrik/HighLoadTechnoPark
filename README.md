...
|---------|-------------------------------------|-----|-----|-----|
| Сервис авторизации/регистрации (Средняя бизнес-логика) | 2*29 RPS | 1 | 110 MB | 0.001392 Gbit |
| Сервис оплаты подписки (Тяжелая бизнес-логика) | 2*4.6 RPS | 10	| 1920 MB | 0.004416 Gbit/s |
| Сервис комментариев (Средняя бизнес-логика) | 2*0.0005 RPS + 2*30 | 1	| 60 MB | 0.36 Gbit/s |
