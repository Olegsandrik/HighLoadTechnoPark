...
|--------------| ----------------| --------------| ----------------| --------------|
| Films | ~500 байт на 1 фильм * 80 тысяч единиц контента * 4 разрешения = **0.148 ГБ**| 115 |  | при удалении фильма удаляются все film_actors и film_geners, reviews |
| Actors |  ~400 байт * 100 000 человек = **0.0373 GB** | | | при удалении удаляются все photos и Film_Actors |
| Users | ~500 байт * 22 млн = **10.24 GB** | 29 |  | при удалении удаляются все avatars и rewies, session |
| Reviews | ~400 байт * 180 млн оценок = **67.11 GB** |  | 8 | - |
...
| Film_Actors | ~16 байт * 200 000 записей = **0.00298 GB**  |  |  | - |
| Film_Genres | ~12 байт * 80 тысяч единиц контента * 3 = **0.00268 GB**|  |  | - |
| Session |  324 байта * 365 * 2 500 000 = **275.6 ГБ** | 29 | 29 | - |
