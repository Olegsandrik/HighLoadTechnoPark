...
| Session |  ~324 байта * 365 * 2 500 000 = **275.6 ГБ** | - | 1 | 29 |
...
Sessions нагрузка на чтение и avatars нагрузка на запись примерные значения, исходя из поведения пользователей.
