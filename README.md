...
# Продуктовые метрики
| ТИП | Месячная аудитория  | Дневная аудитория | Размер хранилища | Кол-во действий |
| ------------- | ------------- | ------------- | ------------- | ------------- | 
| Пиковый | Content Cell  | Content Cell  | Content Cell  | Content Cell  | 
| Средний | Content Cell  | Content Cell  | Content Cell  | Content Cell  |
# Технические метрики
