...
|---------|-------------------------------------|-----|-----|-----|
| Сервис авторизации/регистрации | 29 RPS |	| Tb | Gbit/s |
| Сервис оплаты подписки | 4.6 RPS | 	| Tb | Gbit/s |
| Сервис комментариев | 0.0005 RPS | 	| Tb | Gbit/s |
| Сервис просмотра фильмов |  30141 RPS |	| Tb | Gbit/s |
| Сервис отображения изображений | RPS |	| Tb | Gbit/s |
| Сервис сбора данных |  RPS |	| Tb | Gbit/s |
| Сервис сбора метрик |  RPS |	| Tb | Gbit/s |
| Сервис рекомендаций |  RPS | 	| Tb | Gbit/s |
| Сервис поиска | 115 RPS |	| Tb | Gbit/s |
| Сервис кеширования |  RPS |	| Tb | Gbit/s |
| Сервис добавления контента |  RPS |	| Tb | Gbit/s |
| Сервис обновления рейтинга фильма |  RPS |	| Tb | Gbit/s |


Рассчет: 
* RPS
Для сервиса сбора данных: Тк собираются данные о лайках, просмотрах, остановках видео и просмотре определенных сцен, то RPS будет достаточно высокий. Лайки имеют 0.27 RPS, пользователь в среднем 4-5 раз ставит на паузу за 18 минут просмотра контента => 2 500 000 * 4.5 = 11250000, 11250000/(60 * 60 * 24) = 130 RPS, пользователь смотрит в среднем 1-2 разных материала в день => 1.5 * 2 500 000 = 3750000, 3750000/(60 * 60 * 24) = 43 RPS

Для сервиса сбора данных
...
Для оркестрации будет использоваться k8s. В случае использования kubernetes или иной виртуализации, список контейнеров с аллокацией ресурсов.
...
|---------|-------|-------|-------|-------|-----|
| Сервис авторизации/регистрации | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис оплаты подписки | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис комментариев | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис просмотра фильмов | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис отображения изображений | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис сбора данных | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис сбора метрик | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис рекомендаций | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис поиска | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис кеширования | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис добавления контента | 8 | 8 | 8 Gb | 32 GB | 400 |
| Сервис обновления рейтинга фильма | 8 | 8 | 8 Gb | 32 GB | 400 |
