...
| API Gateway | 14 |
| Nginx | (14+14)*2 + 14|
| Сервис авторизации/регистрации | 1 |
| Сервис оплаты подписки | 1 | 
| Сервис комментариев| 1 |
| Сервис просмотра фильмов | 14 |
| Сервис отображения изображений | 14 |
| Сервис сбора данных | 14 |
| Сервис сбора метрик | 1 |
| Сервис рекомендаций | 1 |
| Сервис поиска | 14 |
| Сервис кеширования | 1 |
| Сервис добавления контента | 1 |
| Сервис обновления рейтинга фильма | 1 |
...
|---------|-------|-------|-------|-------|-----|
| Сервис авторизации/регистрации | 1 | 3 | 110 MB | 330 MB | 1 |
| Сервис оплаты подписки | 10 | 12 | 1920 MB | 2200 MB | 1 | 
| Сервис комментариев | 1 | 2 | 60 MB | 120 MB | 1 |
| Сервис просмотра фильмов | 43 | 45 | 4305 MB	| 4600 MB | 14 |
| Сервис отображения изображений | 1 | 1 | 100 MB	 | 100 MB	 | 14 |
| Сервис сбора данных | 1 | 1 | 100 MB | 100 MB	| 14 |
| Сервис сбора метрик | 1 | 2 | 20 MB | 40 MB| 1 |
| Сервис рекомендаций | 3 | 3 | 300 MB | 300 MB | 1 |
| Сервис поиска | 1 | 1 | 100 MB | 100 MB | 14 |
| Сервис кеширования | 1 | 1 | 50 MB | 50 MB | 1 |
| Сервис добавления контента | 1 | 1 | 	1 MB | 1 MB | 1 |
| Сервис обновления рейтинга фильма | 1 | 1 | 22 MB | 22 MB | 1 |
