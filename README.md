...
|--------------| ----------------| --------------|----------------| --------------|
| Films | ~500 байт на 1 фильм * 80 тысяч единиц контента * 4 разрешения = **0.148 ГБ**| при удалении фильма удаляются все film_actors и film_geners, reviews | 30141/18/60=28 | 0 |
| Actors |  ~400 байт * 100 000 человек = **0.0373 GB** | при удалении удаляются все photos и Film_Actors | 30141/18/60=28 | 0 |
...
| Photos | ~250 байт * 22 млн * 1/3 = **1.705 GB**| - | 30141/18/60=28 | 0 |
| Avatars | ~250 байт * 100 000 = **0.0233 GB**| - | 29 | 1 |
| Film_Actors | ~16 байт * 200 000 записей = **0.00298 GB**  | - | 30141/18/60=28 | 0 |
| Film_Geners | ~12 байт * 160 тысяч единиц контента * 3 = **0.00534 GB**| - | 30141/18/60=28 | 0 |
| Session |  ~324 байта * 365 * 2 500 000 = **275.6 ГБ** | - | 0 | 29 |
