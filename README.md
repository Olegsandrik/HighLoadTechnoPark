...
|---------|-------------------------------------|-----|-----|-----|
| Сервис авторизации/регистрации | RPS | 3000	| Tb | Gbit/s |
| Сервис оплаты подписки |  RPS | 3000	| Tb | Gbit/s |
| Сервис комментариев |  RPS | 3000	| Tb | Gbit/s |
| Сервис просмотра фильмов |  RPS | 3000	| Tb | Gbit/s |
| Сервис отображения изображений |  RPS | 3000	| Tb | Gbit/s |
| Сервис сбора данных |  RPS | 3000	| Tb | Gbit/s |
| Сервис сбора метрик |  RPS | 3000	| Tb | Gbit/s |
| Сервис рекомендаций |  RPS | 3000	| Tb | Gbit/s |
| Сервис поиска |  RPS | 3000	| Tb | Gbit/s |
| Сервис кеширования |  RPS | 3000	| Tb | Gbit/s |
| Сервис добавления контента |  RPS | 3000	| Tb | Gbit/s |
| Сервис обновления рейтинга фильма |  RPS | 3000	| Tb | Gbit/s |
