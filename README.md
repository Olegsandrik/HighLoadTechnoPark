...
|--------------| ----------------| --------------|
| Films | ~500 байт на 1 фильм * 80 тысяч единиц контента * 4 разрешения = **0.148 ГБ**| при удалении фильма удаляются все film_actors и film_geners, reviews |
...
| Reviews | ~400 байт * 180 млн оценок = **67.11 GB** | - |
...
| Session |  324 байта * 365 * 2 500 000 = **275.6 ГБ** | - |
